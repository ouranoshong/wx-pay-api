...
class WXPayConfig
{
     ...
     * @var string
     */
    public  $appId = '你的微信公众号 APPID';
    public  $mchId = '你的微信商户账号';
     ...
     * @var string path
     */
    public $sslPemPath = __DIR__ . '/cert/apiclient_cert.pem';
    public $sslKeyPath = __DIR__ .'/cert/apiclient_key.pem';
